...
setwd("/Users/Niha Yadav/vscode/nihay17.github.io/protfolio/bike-share-success") 
...
write.csv(counts, file = '~/bike-share-success/avg_ridecyc_length.csv')
write.csv(Bike_Share_p2, file = '~/bike-share-success/Cyclistics_sharing.csv')
